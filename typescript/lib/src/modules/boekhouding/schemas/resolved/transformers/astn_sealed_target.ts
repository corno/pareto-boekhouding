                                                ...
                                                ($, id): s_out.Value => ['group', ['verbose', p_.literal.dictionary(
                                                    {
                                                        "Bedrag": p_change_context(
                                                            ...
                                                            ($) => ['text', {
                                                                'delimiter': ['none', null],
                                                                'value': ser_primitives.fractional_decimal(
                                                                    $,
                                                                    {
                                                                                                    ...
                                                                                                    'value': ['group', ['verbose', p_.literal.dictionary(
                                                                                                        {
                                                                                                            ...
                                                                                                            "Betaaldatum": p_change_context(
                                                                                                                ...
                                                                                                                ($) => ['text', {
                                                                                                                    'delimiter': ['none', null],
                                                                                                                    'value': ser_primitives.iso_date_udhr(
                                                                                                                        $,
                                                                                                                    ),
                                                                                                                }],
                                                                                                            ),
...
export const Verwijzing_naar_Informele_rekening: t_signatures.Verwijzing_naar_Informele_rekening = ($) => ['reference', {
    'value': $['l id'],
}]

export const Verwijzing_naar_Bankrekening: t_signatures.Verwijzing_naar_Bankrekening = ($) => ['reference', {
    'value': $['l id'],
}]
...
export const Rekening_Mutatie: t_signatures.Rekening_Mutatie = ($) => ['group', ['verbose', p_.literal.dictionary(
    {
        "Jaar": p_change_context(
            ...
            ($) => ['optional', p_.from.optional($).decide(
                ($): s_out.Value.optional => ['set', ['reference', {
                    'value': $['l id'],
                }]],
                () => ['not set', null],
            )],
...
export const Eerste_boekjaar: t_signatures.Eerste_boekjaar = ($) => ['state', p_.from.state($).decide(
    ($): s_out.Value.state => {
        switch ($[0]) {
            case 'Ja': return p_.option(
                    $,

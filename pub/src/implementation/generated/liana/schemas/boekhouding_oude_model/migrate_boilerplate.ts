...
export const Root: t_signatures.Root = ($) => ({
    'Bankrekeningen': _p.deprecated_cc($['Bankrekeningen'], ($) => $.__d_map(($) => null)),
    'Beheer': _p.deprecated_cc($['Beheer'], ($) => ({
        'Balans': _p.deprecated_cc($['Balans'], ($) => ({
            'Grootboekrekeningen': _p.deprecated_cc($['Grootboekrekeningen'], ($) => $.__d_map(($) => ({
                'Hoofdcategorie': _p.deprecated_cc($['Hoofdcategorie'], ($) => $),
                'Subcategorie': _p.deprecated_cc($['Subcategorie'], ($) => $),
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => _p.deprecated_cc($, ($): t_out.Root.Beheer.Balans.Grootboekrekeningen.D.Zijde => {
                    switch ($[0]) {
            ...
            'Hoofdcategorieen': _p.deprecated_cc($['Hoofdcategorieen'], ($) => $.__d_map(($) => ({
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => _p.deprecated_cc($, ($): t_out.Root.Beheer.Balans.Hoofdcategorieen.D.Zijde => {
                    switch ($[0]) {
                        case 'Activa': return _p.ss($, ($) => ['Activa', null])
                        case 'Passiva': return _p.ss($, ($) => ['Passiva', null])
                        default: return _p.au($[0])
            ...
            'Hoofdcategorieen fiscus': _p.deprecated_cc($['Hoofdcategorieen fiscus'], ($) => $.__d_map(($) => ({
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => _p.deprecated_cc($, ($): t_out.Root.Beheer.Balans.Hoofdcategorieen_fiscus.D.Zijde => {
                    switch ($[0]) {
                        case 'Activa': return _p.ss($, ($) => ['Activa', null])
                        case 'Passiva': return _p.ss($, ($) => ['Passiva', null])
                        default: return _p.au($[0])
        ...
        'BTW-categorieen': _p.deprecated_cc($['BTW-categorieen'], ($) => $.__d_map(($) => ({
            'BTW-heffing': _p.deprecated_cc($['BTW-heffing'], ($) => _p.deprecated_cc($, ($): t_out.Root.Beheer.BTW$mi_categorieen.D.BTW$mi_heffing => {
                switch ($[0]) {
        ...
        'Resultaat': _p.deprecated_cc($['Resultaat'], ($) => ({
            ...
            'Grootboekrekeningen': _p.deprecated_cc($['Grootboekrekeningen'], ($) => $.__d_map(($) => ({
                'Hoofdcategorie': _p.deprecated_cc($['Hoofdcategorie'], ($) => $),
                'Subcategorie': _p.deprecated_cc($['Subcategorie'], ($) => $),
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => _p.deprecated_cc($, ($): t_out.Root.Beheer.Resultaat.Grootboekrekeningen.D.Zijde => {
                    switch ($[0]) {
                        case 'Kosten': return _p.ss($, ($) => ['Kosten', ({
                            'Correctie op vennootschapsbelasting': _p.deprecated_cc($['Correctie op vennootschapsbelasting'], ($) => _p.deprecated_cc($, ($): t_out.Root.Beheer.Resultaat.Grootboekrekeningen.D.Zijde.Kosten.Correctie_op_vennootschapsbelasting => {
                                switch ($[0]) {
                                    case 'Ja': return _p.ss($, ($) => ['Ja', ({
            ...
            'Hoofdcategorieen': _p.deprecated_cc($['Hoofdcategorieen'], ($) => $.__d_map(($) => ({
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => _p.deprecated_cc($, ($): t_out.Root.Beheer.Resultaat.Hoofdcategorieen.D.Zijde => {
                    switch ($[0]) {
            ...
            'Hoofdcategorieen fiscus': _p.deprecated_cc($['Hoofdcategorieen fiscus'], ($) => $.__d_map(($) => ({
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => _p.deprecated_cc($, ($): t_out.Root.Beheer.Resultaat.Hoofdcategorieen_fiscus.D.Zijde => {
                    switch ($[0]) {
                        case 'Kosten': return _p.ss($, ($) => ['Kosten', null])
                        case 'Opbrengsten': return _p.ss($, ($) => ['Opbrengsten', null])
                        default: return _p.au($[0])
    ...
    'Informele rekeningen': _p.deprecated_cc($['Informele rekeningen'], ($) => $.__d_map(($) => null)),
    'Jaren': _p.deprecated_cc($['Jaren'], ($) => $.__d_map(($) => ({
        'Afgesloten': _p.deprecated_cc($['Afgesloten'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Afgesloten => {
            switch ($[0]) {
        ...
        'Balans grootboekrekeningen': _p.deprecated_cc($['Balans grootboekrekeningen'], ($) => $.__d_map(($) => ({
            'Type': _p.deprecated_cc($['Type'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Balans_grootboekrekeningen.D.Type => {
                switch ($[0]) {
        ...
        'Bankrekeningen': _p.deprecated_cc($['Bankrekeningen'], ($) => $.__d_map(($) => ({
            ...
            'Mutaties': _p.deprecated_cc($['Mutaties'], ($) => $.__d_map(($) => ({
                ...
                'Status': _p.deprecated_cc($['Status'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Bankrekeningen.D.Mutaties.D.Status => {
                    switch ($[0]) {
                        case 'Nog te verwerken': return _p.ss($, ($) => ['Nog te verwerken', null])
                        case 'Verwerkt': return _p.ss($, ($) => ['Verwerkt', ({
                            'Afhandeling': _p.deprecated_cc($['Afhandeling'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Bankrekeningen.D.Mutaties.D.Status.Verwerkt.Afhandeling => {
                                switch ($[0]) {
                                    case 'Inkoop': return _p.ss($, ($) => ['Inkoop', ({
                                    ...
                                    case 'BTW-periode': return _p.ss($, ($) => ['BTW-periode', ({
                                        'Jaar': _p.deprecated_cc($['Jaar'], ($) => $),
                                        'BTW-periode': _p.deprecated_cc($['BTW-periode'], ($) => $),
                                    })])
                                    case 'Verkoop': return _p.ss($, ($) => ['Verkoop', ({
                                        'Jaar': _p.deprecated_cc($['Jaar'], ($) => $),
            ...
            'Nieuw': _p.deprecated_cc($['Nieuw'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Bankrekeningen.D.Nieuw => {
                switch ($[0]) {
                    case 'Ja': return _p.ss($, ($) => ['Ja', null])
        ...
        'BTW periodes': _p.deprecated_cc($['BTW periodes'], ($) => $.__d_map(($) => ({
            ...
            'Omschrijving': _p.deprecated_cc($['Omschrijving'], ($) => $),
            'Status': _p.deprecated_cc($['Status'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.BTW_periodes.D.Status => {
                switch ($[0]) {
        ...
        'Eerste boekjaar': _p.deprecated_cc($['Eerste boekjaar'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Eerste_boekjaar => {
            switch ($[0]) {
                case 'Ja': return _p.ss($, ($) => ['Ja', null])
                case 'Nee': return _p.ss($, ($) => ['Nee', ({
        ...
        'Informele rekeningen': _p.deprecated_cc($['Informele rekeningen'], ($) => $.__d_map(($) => ({
            'Beginsaldo': _p.deprecated_cc($['Beginsaldo'], ($) => $),
            'Grootboekrekening': _p.deprecated_cc($['Grootboekrekening'], ($) => $),
            'Nieuw': _p.deprecated_cc($['Nieuw'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Informele_rekeningen.D.Nieuw => {
                switch ($[0]) {
                    case 'Ja': return _p.ss($, ($) => ['Ja', null])
                    case 'Nee': return _p.ss($, ($) => ['Nee', ({
                        'Jaar': _p.deprecated_cc($['Jaar'], ($) => $),
        ...
        'Inkopen': _p.deprecated_cc($['Inkopen'], ($) => $.__d_map(($) => ({
            'Afhandeling': _p.deprecated_cc($['Afhandeling'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Inkopen.D.Afhandeling => {
                switch ($[0]) {
            ...
            'BTW-regime': _p.deprecated_cc($['BTW-regime'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Inkopen.D.BTW$mi_regime => {
                switch ($[0]) {
                    case 'Binnenland: heffing verlegd': return _p.ss($, ($) => ['Binnenland: heffing verlegd', null])
                    case 'Geen BTW van toepassing': return _p.ss($, ($) => ['Geen BTW van toepassing', ({
                        'BTW-periode': _p.deprecated_cc($['BTW-periode'], ($) => $),
                    })])
            ...
            'Brondocument': _p.deprecated_cc($['Brondocument'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Inkopen.D.Brondocument => {
                switch ($[0]) {
                    ...
                    case 'Nog toevoegen': return _p.ss($, ($) => ['Nog toevoegen', null])
                    default: return _p.au($[0])
                }
            })),
            'Datum': _p.deprecated_cc($['Datum'], ($) => $),
            'Regels': _p.deprecated_cc($['Regels'], ($) => $.__d_map(($) => ({
                'Bedrag': _p.deprecated_cc($['Bedrag'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Inkopen.D.Regels.D.Bedrag => {
                    switch ($[0]) {
                ...
                'Omschrijving': _p.deprecated_cc($['Omschrijving'], ($) => $),
                'Type': _p.deprecated_cc($['Type'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Inkopen.D.Regels.D.Type => {
                    switch ($[0]) {
            ...
            'Type': _p.deprecated_cc($['Type'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Inkopen.D.Type => {
                switch ($[0]) {
        ...
        'Overige balans items': _p.deprecated_cc($['Overige balans items'], ($) => $.__d_map(($) => ({
            'Beginsaldo': _p.deprecated_cc($['Beginsaldo'], ($) => $),
            'Grootboekrekening': _p.deprecated_cc($['Grootboekrekening'], ($) => $),
            'Memoriaal boekingen': _p.deprecated_cc($['Memoriaal boekingen'], ($) => $.__d_map(($) => ({
                'Bedrag': _p.deprecated_cc($['Bedrag'], ($) => $),
                'Datum': _p.deprecated_cc($['Datum'], ($) => $),
                'Grootboekrekening': _p.deprecated_cc($['Grootboekrekening'], ($) => $),
                'Omschrijving': _p.deprecated_cc($['Omschrijving'], ($) => $),
            }))),
            'Nieuw': _p.deprecated_cc($['Nieuw'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Overige_balans_items.D.Nieuw => {
                switch ($[0]) {
                    case 'Ja': return _p.ss($, ($) => ['Ja', null])
                    case 'Nee': return _p.ss($, ($) => ['Nee', ({
                        'Jaar': _p.deprecated_cc($['Jaar'], ($) => $),
        ...
        'Resultaat grootboekrekeningen': _p.deprecated_cc($['Resultaat grootboekrekeningen'], ($) => $.__d_map(($) => null)),
        ...
        'Verkopen': _p.deprecated_cc($['Verkopen'], ($) => $.__d_map(($) => ({
            'Afhandeling': _p.deprecated_cc($['Afhandeling'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Verkopen.D.Afhandeling => {
                switch ($[0]) {
                    case 'Mutaties': return _p.ss($, ($) => ['Mutaties', null])
                    case 'Rekening courant': return _p.ss($, ($) => ['Rekening courant', ({
                        'Rekening courant': _p.deprecated_cc($['Rekening courant'], ($) => $),
            ...
            'BTW-periode': _p.deprecated_cc($['BTW-periode'], ($) => $),
            'Brondocument': _p.deprecated_cc($['Brondocument'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Verkopen.D.Brondocument => {
                switch ($[0]) {
                    case 'Toegevoegd': return _p.ss($, ($) => ['Toegevoegd', ({
                        'Document': _p.deprecated_cc($['Document'], ($) => Bestandsnaam(
                            $
            ...
            'Contracttype': _p.deprecated_cc($['Contracttype'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Verkopen.D.Contracttype => {
                switch ($[0]) {
            ...
            'Regels': _p.deprecated_cc($['Regels'], ($) => $.__d_map(($) => ({
                'BTW-regime': _p.deprecated_cc($['BTW-regime'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Verkopen.D.Regels.D.BTW$mi_regime => {
                    switch ($[0]) {
                        case 'Intracommunautair': return _p.ss($, ($) => ['Intracommunautair', null])
                        case 'Standaard': return _p.ss($, ($) => ['Standaard', ({
                ...
                'Contracttype': _p.deprecated_cc($['Contracttype'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Verkopen.D.Regels.D.Contracttype => {
                    switch ($[0]) {
                        case 'Project': return _p.ss($, ($) => ['Project', ({
                ...
                'Omschrijving': _p.deprecated_cc($['Omschrijving'], ($) => $),
                'Type': _p.deprecated_cc($['Type'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Verkopen.D.Regels.D.Type => {
                    switch ($[0]) {
        ...
        'Verrekenposten': _p.deprecated_cc($['Verrekenposten'], ($) => $.__d_map(($) => ({
            'Mutaties': _p.deprecated_cc($['Mutaties'], ($) => $.__d_map(($) => ({
                'Bedrag': _p.deprecated_cc($['Bedrag'], ($) => $),
                'Afhandeling': _p.deprecated_cc($['Afhandeling'], ($) => _p.deprecated_cc($, ($): t_out.Root.Jaren.D.Verrekenposten.D.Mutaties.D.Afhandeling => {
                    switch ($[0]) {
                        case 'Inkoop': return _p.ss($, ($) => ['Inkoop', ({
                            'Jaar': _p.deprecated_cc($['Jaar'], ($) => $),
                            'Inkoop': _p.deprecated_cc($['Inkoop'], ($) => $),
        ...
        'Projecten': _p.deprecated_cc($['Projecten'], ($) => $.__d_map(($) => ({
            'Offertes': _p.deprecated_cc($['Offertes'], ($) => $.__d_map(($) => ({
                'Opbrengsten': _p.deprecated_cc($['Opbrengsten'], ($) => $.__d_map(($) => ({
                    'Type': _p.deprecated_cc($['Type'], ($) => _p.deprecated_cc($, ($): t_out.Root.Klanten.D.Projecten.D.Offertes.D.Opbrengsten.D.Type => {
                        switch ($[0]) {
                            case 'Project': return _p.ss($, ($) => ['Project', ({
                                'Bedrag': _p.deprecated_cc($['Bedrag'], ($) => $),

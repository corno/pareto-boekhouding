        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Fiscaal.Balans_Hoofdcategorieen.dictionary.D.entry.Zijde.state => {
                        switch ($[0]) {
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Fiscaal.Resultaat_Hoofdcategorieen.dictionary.D.entry.Zijde.state => {
                        switch ($[0]) {
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Grootboek_Categorieen.Balans.dictionary.D.entry.Zijde.state => {
                        switch ($[0]) {
                            case 'Activa': return _p.ss($, ($) => ['Activa', null])
                            case 'Passiva': return _p.ss($, ($) => ['Passiva', null])
                            default: return _p.au($[0])
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                'Zijde': _p.deprecated_cc($['Zijde'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Grootboek_Categorieen.Resultaat.dictionary.D.entry.Zijde.state => {
                        switch ($[0]) {
                            case 'Kosten': return _p.ss($, ($) => ['Kosten', null])
                            case 'Opbrengsten': return _p.ss($, ($) => ['Opbrengsten', null])
                            default: return _p.au($[0])
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                'BTW-heffing': _p.deprecated_cc($['BTW-heffing'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Beheer.BTW$mi_categorieen.dictionary.D.entry.BTW$mi_heffing.state => {
                        switch ($[0]) {
            ...
            'dictionary': $.__d_map(($) => ({
                'entry': ({
                    ...
                    'Zijde': _p.deprecated_cc($['Zijde'], ($) => ({
                        ...
                        'state': _p.deprecated_cc($, ($): t_out.Beheer.Grootboekrekeningen.Balans.dictionary.D.entry.Zijde.state => {
                            switch ($[0]) {
                                case 'Activa': return _p.ss($, ($) => ['Activa', null])
                                case 'Passiva': return _p.ss($, ($) => ['Passiva', null])
                                default: return _p.au($[0])
            ...
            'dictionary': $.__d_map(($) => ({
                'entry': ({
                    ...
                    'Zijde': _p.deprecated_cc($['Zijde'], ($) => ({
                        ...
                        'state': _p.deprecated_cc($, ($): t_out.Beheer.Grootboekrekeningen.Resultaat.dictionary.D.entry.Zijde.state => {
                            switch ($[0]) {
                                case 'Kosten': return _p.ss($, ($) => ['Kosten', ({
                                    'Correctie op vennootschapsbelasting': _p.deprecated_cc($['Correctie op vennootschapsbelasting'], ($) => ({
                                        ...
                                        'state': _p.deprecated_cc($, ($): t_out.Beheer.Grootboekrekeningen.Resultaat.dictionary.D.entry.Zijde.state.Kosten.Correctie_op_vennootschapsbelasting.state => {
                                            switch ($[0]) {
                                                case 'Ja': return _p.ss($, ($) => ['Ja', ({
                                            ...
                                            'dictionary': $.__d_map(($) => ({
                                                'entry': ({
                                                    'Type': _p.deprecated_cc($['Type'], ($) => ({
                                                        ...
                                                        'state': _p.deprecated_cc($, ($): t_out.Beheer.Klanten.dictionary.D.entry.Projecten.dictionary.D.entry.Offertes.dictionary.D.entry.Opbrengsten.dictionary.D.entry.Type.state => {
                                                            switch ($[0]) {
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                'Type': _p.deprecated_cc($['Type'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Grootboekrekeningen.Balans.dictionary.D.entry.Type.state => {
                        switch ($[0]) {
            ...
            'dictionary': $.__d_map(($) => ({
                'entry': ({
                    ...
                    'Status': _p.deprecated_cc($['Status'], ($) => ({
                        ...
                        'state': _p.deprecated_cc($, ($): t_out.Jaarbeheer.Resultaat.BTW_periodes.dictionary.D.entry.Status.state => {
                            switch ($[0]) {
            ...
            'dictionary': $.__d_map(($) => ({
                'entry': ({
                    ...
                    'Nieuw': _p.deprecated_cc($['Nieuw'], ($) => ({
                        ...
                        'state': _p.deprecated_cc($, ($): t_out.Jaarbeheer.Balans.Informele_rekeningen.dictionary.D.entry.Nieuw.state => {
                            switch ($[0]) {
            ...
            'dictionary': $.__d_map(($) => ({
                'entry': ({
                    ...
                    'Nieuw': _p.deprecated_cc($['Nieuw'], ($) => ({
                        ...
                        'state': _p.deprecated_cc($, ($): t_out.Jaarbeheer.Balans.Bankrekeningen.dictionary.D.entry.Nieuw.state => {
                            switch ($[0]) {
                                case 'Ja': return _p.ss($, ($) => ['Ja', null])
                                case 'Nee': return _p.ss($, ($) => ['Nee', ({
...
export const Overige_balans_item: t_signatures.Overige_balans_item = ($) => ({
    ...
    'Nieuw': _p.deprecated_cc($['Nieuw'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Overige_balans_item.Nieuw.state => {
            switch ($[0]) {
                case 'Ja': return _p.ss($, ($) => ['Ja', null])
                case 'Nee': return _p.ss($, ($) => ['Nee', ({
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                'Afhandeling': _p.deprecated_cc($['Afhandeling'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Inkopen.dictionary.D.entry.Afhandeling.state => {
                        switch ($[0]) {
                ...
                'BTW-regime': _p.deprecated_cc($['BTW-regime'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Inkopen.dictionary.D.entry.BTW$mi_regime.state => {
                        switch ($[0]) {
                ...
                'Brondocument': _p.deprecated_cc($['Brondocument'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Inkopen.dictionary.D.entry.Brondocument.state => {
                        switch ($[0]) {
                    ...
                    'dictionary': $.__d_map(($) => ({
                        'entry': ({
                            'Bedrag': _p.deprecated_cc($['Bedrag'], ($) => ({
                                ...
                                'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Inkopen.dictionary.D.entry.Regels.dictionary.D.entry.Bedrag.state => {
                                    switch ($[0]) {
                            ...
                            'Type': _p.deprecated_cc($['Type'], ($) => ({
                                ...
                                'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Inkopen.dictionary.D.entry.Regels.dictionary.D.entry.Type.state => {
                                    switch ($[0]) {
                ...
                'Type': _p.deprecated_cc($['Type'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Inkopen.dictionary.D.entry.Type.state => {
                        switch ($[0]) {
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                'Afhandeling': _p.deprecated_cc($['Afhandeling'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Verkopen.dictionary.D.entry.Afhandeling.state => {
                        switch ($[0]) {
                            case 'Mutaties': return _p.ss($, ($) => ['Mutaties', null])
                            case 'Rekening courant': return _p.ss($, ($) => ['Rekening courant', ({
                                'Rekening courant': _p.deprecated_cc($['Rekening courant'], ($) => ({
                ...
                'Brondocument': _p.deprecated_cc($['Brondocument'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Verkopen.dictionary.D.entry.Brondocument.state => {
                        switch ($[0]) {
                            case 'Toegevoegd': return _p.ss($, ($) => ['Toegevoegd', ({
                                'Document': _p.deprecated_cc($['Document'], ($) => $),
                            })])
                ...
                'Contracttype': _p.deprecated_cc($['Contracttype'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Verkopen.dictionary.D.entry.Contracttype.state => {
                        switch ($[0]) {
                            case 'Project': return _p.ss($, ($) => ['Project', ({
                    ...
                    'dictionary': $.__d_map(($) => ({
                        'entry': ({
                            'BTW-regime': _p.deprecated_cc($['BTW-regime'], ($) => ({
                                ...
                                'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Verkopen.dictionary.D.entry.Regels.dictionary.D.entry.BTW$mi_regime.state => {
                                    switch ($[0]) {
                                        case 'Intracommunautair': return _p.ss($, ($) => ['Intracommunautair', null])
                                        case 'Standaard': return _p.ss($, ($) => ['Standaard', ({
                            ...
                            'Contracttype': _p.deprecated_cc($['Contracttype'], ($) => ({
                                ...
                                'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Verkopen.dictionary.D.entry.Regels.dictionary.D.entry.Contracttype.state => {
                                    switch ($[0]) {
                                        case 'Project': return _p.ss($, ($) => ['Project', ({
                            ...
                            'Type': _p.deprecated_cc($['Type'], ($) => ({
                                ...
                                'state': _p.deprecated_cc($, ($): t_out.Handelstransacties.Verkopen.dictionary.D.entry.Regels.dictionary.D.entry.Type.state => {
                                    switch ($[0]) {
                ...
                'dictionary': $.__d_map(($) => ({
                    'entry': ({
                        ...
                        'Afhandeling': _p.deprecated_cc($['Afhandeling'], ($) => ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Mutaties.Verrekenpost_mutaties.dictionary.D.entry.dictionary.D.entry.Afhandeling.state => {
                                switch ($[0]) {
                                    ...
                                    case 'Balans': return _p.ss($, ($) => ['Balans', ({
                                        ...
                                        'state': _p.deprecated_cc($, ($): t_out.Mutaties.Verrekenpost_mutaties.dictionary.D.entry.dictionary.D.entry.Afhandeling.state.Balans.state => {
                                            switch ($[0]) {
            ...
            'entry': ({
                ...
                'dictionary': $.__d_map(($) => ({
                    'entry': ({
                        ...
                        'state': _p.deprecated_cc($, ($): t_out.Mutaties.Bankrekening_Mutatie_Verwerkingen.dictionary.D.entry.dictionary.D.entry.state => {
                            switch ($[0]) {
                                case 'Resultaat': return _p.ss($, ($) => ['Resultaat', Balans_Resultaat_Mutatie(
                                    $
                                )])
                                case 'Balans': return _p.ss($, ($) => ['Balans', ({
                                    ...
                                    'state': _p.deprecated_cc($, ($): t_out.Mutaties.Bankrekening_Mutatie_Verwerkingen.dictionary.D.entry.dictionary.D.entry.state.Balans.state => {
                                        switch ($[0]) {
                                            case 'Informele rekening': return _p.ss($, ($) => ['Informele rekening', ({
                                                'Informele rekening': _p.deprecated_cc($['Informele rekening'], ($) => ({
                                                    'location': ({
    ...
    'dictionary': $.__d_map(($) => ({
        'entry': ({
            'Afgesloten': _p.deprecated_cc($['Afgesloten'], ($) => ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Jaren.dictionary.D.entry.Afgesloten.state => {
                    switch ($[0]) {
                        case 'Ja': return _p.ss($, ($) => ['Ja', null])
                        case 'Nee': return _p.ss($, ($) => ['Nee', null])
                        default: return _p.au($[0])
...
export const Balans_Resultaat_Mutatie: t_signatures.Balans_Resultaat_Mutatie = ($) => ({
    ...
    'type': _p.deprecated_cc($['type'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Balans_Resultaat_Mutatie.type_.state => {
            switch ($[0]) {
...
export const Eerste_boekjaar: t_signatures.Eerste_boekjaar = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Eerste_boekjaar.state => {
        switch ($[0]) {
            case 'Ja': return _p.ss($, ($) => ['Ja', null])
            case 'Nee': return _p.ss($, ($) => ['Nee', ({

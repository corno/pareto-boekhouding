...
export const Beheer: d_signatures.Beheer = ($) => ({
    'BTW-categorieen': _psh.wrap_dictionary(_p.cc($.Beheer['BTW-categorieen'], ($) => $.map(($): d_out.Beheer.BTW$mi_categorieen.D<d_token._T_Range> => ({
        'BTW-heffing': _p.cc($['BTW-heffing'], ($) => _p.cc($, ($): d_out.Beheer.BTW$mi_categorieen.D.BTW$mi_heffing<d_token._T_Range> => {
            switch ($[0]) {
    ...
    'Grootboekrekeningen': _p.cc($, ($): d_out.Beheer.Grootboekrekeningen<d_token._T_Range> => ({
        'Balans': _psh.wrap_dictionary(_p.cc($.Beheer['Balans'].Grootboekrekeningen, ($) => $.map(($) => ({
            ...
            'Zijde': _p.cc($['Zijde'], ($) => _p.cc($, ($): d_out.Beheer.Grootboekrekeningen.Balans.D.Zijde<d_token._T_Range> => {
                switch ($[0]) {
        ...
        'Resultaat': _psh.wrap_dictionary(_p.cc($.Beheer['Resultaat'].Grootboekrekeningen, ($) => $.map(($) => ({
            'Hoofdcategorie': _p.cc($['Hoofdcategorie'], ($) => _psh.wrap_reference($)),
            'Subcategorie': _p.cc($['Subcategorie'], ($) => _psh.wrap_reference($)),
            'Zijde': _p.cc($['Zijde'], ($) => _p.cc($, ($): d_out.Beheer.Grootboekrekeningen.Resultaat.D.Zijde<d_token._T_Range> => {
                switch ($[0]) {
                    case 'Kosten': return _p.ss($, ($) => _psh.wrap_state_group(['Kosten', ({
                        'Correctie op vennootschapsbelasting': _p.cc($['Correctie op vennootschapsbelasting'], ($) => _p.cc($, ($): d_out.Beheer.Grootboekrekeningen.Resultaat.D.Zijde.SG.Kosten.Correctie_op_vennootschapsbelasting<d_token._T_Range> => {
                            switch ($[0]) {
                                case 'Ja': return _p.ss($, ($) => _psh.wrap_state_group(['Ja', ({
        ...
        'Projecten': _p.cc($['Projecten'], ($) => _psh.wrap_dictionary($.map(($) => ({
            'Offertes': _p.cc($['Offertes'], ($) => _psh.wrap_dictionary($.map(($) => ({
                'Opbrengsten': _p.cc($['Opbrengsten'], ($) => _psh.wrap_dictionary($.map(($) => ({
                    'Type': _p.cc($['Type'], ($) => _p.cc($, ($): d_out.Beheer.Klanten.D.Projecten.D.Offertes.D.Opbrengsten.D.Type<d_token._T_Range> => {
                        switch ($[0]) {
...
export const Eerste_boekjaar: d_signatures.Eerste_boekjaar = ($) => _p.cc($, ($): d_out.Eerste_boekjaar<d_token._T_Range> => {
    switch ($[0]) {
...
export const Fiscaal: d_signatures.Fiscaal = ($) => ({
    'Balans Hoofdcategorieen': _p.cc($.Beheer.Balans['Hoofdcategorieen fiscus'], ($) => _psh.wrap_dictionary($.map(($) => ({
        ...
        'Zijde': _p.cc($['Zijde'], ($) => _p.cc($, ($): d_out.Fiscaal.Balans_Hoofdcategorieen.D.Zijde<d_token._T_Range> => {
            switch ($[0]) {
                case 'Activa': return _p.ss($, ($) => _psh.wrap_state_group(['Activa', null]))
                case 'Passiva': return _p.ss($, ($) => _psh.wrap_state_group(['Passiva', null]))
                default: return _p.au($[0])
    ...
    'Resultaat Hoofdcategorieen': _psh.wrap_dictionary(_p.cc($.Beheer.Resultaat['Hoofdcategorieen fiscus'], ($) => $.map(($) => ({
        'Subcategorieen': _p.cc($['Subcategorieen'], ($) => _psh.wrap_dictionary($.map(($) => null))),
        'Zijde': _p.cc($['Zijde'], ($) => _p.cc($, ($): d_out.Fiscaal.Resultaat_Hoofdcategorieen.D.Zijde<d_token._T_Range> => {
            switch ($[0]) {
...
export const Grootboek_Categorieen: d_signatures.Grootboek_Categorieen = ($) => ({
    'Balans': _p.cc($.Beheer.Balans.Hoofdcategorieen, ($) => _psh.wrap_dictionary($.map(($) => ({
        ...
        'Zijde': _p.cc($['Zijde'], ($) => _p.cc($, ($): d_out.Grootboek_Categorieen.Balans.D.Zijde<d_token._T_Range> => {
            switch ($[0]) {
                case 'Activa': return _p.ss($, ($) => _psh.wrap_state_group(['Activa', null]))
                case 'Passiva': return _p.ss($, ($) => _psh.wrap_state_group(['Passiva', null]))
                default: return _p.au($[0])
    ...
    'Resultaat': _p.cc($.Beheer['Resultaat'].Hoofdcategorieen, ($) => _psh.wrap_dictionary($.map(($) => ({
        ...
        'Zijde': _p.cc($['Zijde'], ($) => _p.cc($, ($): d_out.Grootboek_Categorieen.Resultaat.D.Zijde<d_token._T_Range> => {
            switch ($[0]) {
                case 'Kosten': return _p.ss($, ($) => _psh.wrap_state_group(['Kosten', null]))
                case 'Opbrengsten': return _p.ss($, ($) => _psh.wrap_state_group(['Opbrengsten', null]))
                default: return _p.au($[0])
...
export const Grootboekrekeningen: d_signatures.Grootboekrekeningen = ($) => ({
    'Balans': _p.cc($['Balans grootboekrekeningen'], ($) => _psh.wrap_dictionary($.map(($) => ({
        'Type': _p.cc($['Type'], ($) => _p.cc($, ($): d_out.Grootboekrekeningen.Balans.D.Type<d_token._T_Range> => {
            switch ($[0]) {
...
export const Handelstransacties: d_signatures.Handelstransacties = ($) => ({
    'Inkopen': _p.cc($['Inkopen'], ($) => _psh.wrap_dictionary($.map(($) => ({
        'Afhandeling': _p.cc($['Afhandeling'], ($) => _p.cc($, ($): d_out.Handelstransacties.Inkopen.D.Afhandeling<d_token._T_Range> => {
            switch ($[0]) {
        ...
        'BTW-regime': _p.cc($['BTW-regime'], ($) => _p.cc($, ($): d_out.Handelstransacties.Inkopen.D.BTW$mi_regime<d_token._T_Range> => {
            switch ($[0]) {
        ...
        'Brondocument': _p.cc($['Brondocument'], ($) => _p.cc($, ($): d_out.Handelstransacties.Inkopen.D.Brondocument<d_token._T_Range> => {
            switch ($[0]) {
        ...
        'Regels': _p.cc($['Regels'], ($) => _psh.wrap_dictionary($.map(($) => ({
            'Bedrag': _p.cc($['Bedrag'], ($) => _p.cc($, ($): d_out.Handelstransacties.Inkopen.D.Regels.D.Bedrag<d_token._T_Range> => {
                switch ($[0]) {
            ...
            'Type': _p.cc($['Type'], ($) => _p.cc($, ($): d_out.Handelstransacties.Inkopen.D.Regels.D.Type<d_token._T_Range> => {
                switch ($[0]) {
        ...
        'Type': _p.cc($['Type'], ($) => _p.cc($, ($): d_out.Handelstransacties.Inkopen.D.Type<d_token._T_Range> => {
            switch ($[0]) {
    ...
    'Verkopen': _p.cc($['Verkopen'], ($) => _psh.wrap_dictionary($.map(($) => ({
        'Afhandeling': _p.cc($['Afhandeling'], ($) => _p.cc($, ($): d_out.Handelstransacties.Verkopen.D.Afhandeling<d_token._T_Range> => {
            switch ($[0]) {
                case 'Mutaties': return _p.ss($, ($) => _psh.wrap_state_group(['Mutaties', null]))
                case 'Rekening courant': return _p.ss($, ($) => _psh.wrap_state_group(['Rekening courant', ({
                    'Rekening courant': _p.cc($['Rekening courant'], ($) => _psh.wrap_reference($)),
        ...
        'Brondocument': _p.cc($['Brondocument'], ($) => _p.cc($, ($): d_out.Handelstransacties.Verkopen.D.Brondocument<d_token._T_Range> => {
            switch ($[0]) {
                case 'Toegevoegd': return _p.ss($, ($) => _psh.wrap_state_group(['Toegevoegd', ({
                    'Document': _p.cc($['Document'], ($) => $),
                })]))
        ...
        'Contracttype': _p.cc($['Contracttype'], ($) => _p.cc($, ($): d_out.Handelstransacties.Verkopen.D.Contracttype<d_token._T_Range> => {
            switch ($[0]) {
        ...
        'Regels': _p.cc($['Regels'], ($) => _psh.wrap_dictionary($.map(($) => ({
            'BTW-regime': _p.cc($['BTW-regime'], ($) => _p.cc($, ($): d_out.Handelstransacties.Verkopen.D.Regels.D.BTW$mi_regime<d_token._T_Range> => {
                switch ($[0]) {
                    case 'Binnenland: heffing verlegd': return _p.ss($, ($) => _psh.wrap_state_group(['Binnenland: heffing verlegd', null]))
                    case 'Intracommunautair': return _p.ss($, ($) => _psh.wrap_state_group(['Intracommunautair', null]))
                    case 'Standaard': return _p.ss($, ($) => _psh.wrap_state_group(['Standaard', ({
            ...
            'Contracttype': _p.cc($['Contracttype'], ($) => _p.cc($, ($): d_out.Handelstransacties.Verkopen.D.Regels.D.Contracttype<d_token._T_Range> => {
                switch ($[0]) {
                    case 'Licentieovereenkomst': return _p.ss($, ($) => _psh.wrap_state_group(['Licentieovereenkomst', ({
            ...
            'Omschrijving': _p.cc($['Omschrijving'], ($) => $),
            'Type': _p.cc($['Type'], ($) => _p.cc($, ($): d_out.Handelstransacties.Verkopen.D.Regels.D.Type<d_token._T_Range> => {
                switch ($[0]) {
                    case 'Balans': return _p.ss($, ($) => _psh.wrap_state_group(['Balans', ({
                        'Balans item': _p.cc($['Balans item'], ($) => _psh.wrap_reference($)),
                    })]))
...
export const Jaarbeheer: d_signatures.Jaarbeheer = ($) => ({
    'Balans': _p.cc($, ($) => ({
        'Bankrekeningen': _p.cc($['Bankrekeningen'], ($) => _psh.wrap_dictionary($.map(($) => ({
            ...
            'Nieuw': _p.cc($['Nieuw'], ($) => _p.cc($, ($): d_out.Jaarbeheer.Balans.Bankrekeningen.D.Nieuw<d_token._T_Range> => {
                switch ($[0]) {
                    case 'Ja': return _p.ss($, ($) => _psh.wrap_state_group(['Ja', null]))
                    case 'Nee': return _p.ss($, ($) => _psh.wrap_state_group(['Nee', ({
        ...
        'Informele rekeningen': _p.cc($['Informele rekeningen'], ($) => _psh.wrap_dictionary($.map(($) => ({
            'Beginsaldo': _p.cc($['Beginsaldo'], ($) => $),
            'Grootboekrekening': _p.cc($['Grootboekrekening'], ($) => _psh.wrap_reference($)),
            'Nieuw': _p.cc($['Nieuw'], ($) => _p.cc($, ($): d_out.Jaarbeheer.Balans.Informele_rekeningen.D.Nieuw<d_token._T_Range> => {
                switch ($[0]) {
                    case 'Ja': return _p.ss($, ($) => _psh.wrap_state_group(['Ja', null]))
                    case 'Nee': return _p.ss($, ($) => _psh.wrap_state_group(['Nee', ({
    ...
    'Resultaat': _p.cc($, ($) => ({
        'BTW periodes': _p.cc($['BTW periodes'], ($) => _psh.wrap_dictionary($.map(($) => ({
            ...
            'Omschrijving': _p.cc($['Omschrijving'], ($) => $),
            'Status': _p.cc($['Status'], ($) => _p.cc($, ($): d_out.Jaarbeheer.Resultaat.BTW_periodes.D.Status<d_token._T_Range> => {
                switch ($[0]) {
...
export const Jaren: d_signatures.Jaren = ($) => _psh.wrap_dictionary($.Jaren.map(($, key) => ({
    'Afgesloten': _p.cc($['Afgesloten'], ($) => _p.cc($, ($): d_out.Jaren.D.Afgesloten<d_token._T_Range> => {
        switch ($[0]) {
            case 'Ja': return _p.ss($, ($) => _psh.wrap_state_group(['Ja', null]))
            case 'Nee': return _p.ss($, ($) => _psh.wrap_state_group(['Nee', null]))
            default: return _p.au($[0])
...
export const Mutaties: d_signatures.Mutaties = ($, $p) => ({
    ...
    'Verrekenpost mutaties': _p.cc($.Verrekenposten, ($) => _psh.wrap_dictionary($.map(($) => _psh.wrap_dictionary($.Mutaties.map(($) => ({
        'Afhandeling': _p.cc($['Afhandeling'], ($) => _p.cc($, ($): d_out.Mutaties.Verrekenpost_mutaties.D.D.Afhandeling<d_token._T_Range> => {
            switch ($[0]) {
                case 'Informele rekening': return _p.ss($, ($) => _psh.wrap_state_group(['Balans', _psh.wrap_state_group(['Informele rekening', ({
                    'Informele rekening': _p.cc($['Informele rekening'], ($) => _psh.wrap_reference($)),
                })])]))
...
export const Overige_balans_item: d_signatures.Overige_balans_item = ($) => ({
    'Beginsaldo': _p.cc($, ($) => $.Beginsaldo),
    'Grootboekrekening': _p.cc($['Grootboekrekening'], ($) => _psh.wrap_reference($)),
    'Nieuw': _p.cc($['Nieuw'], ($) => _p.cc($, ($): d_out.Overige_balans_item.Nieuw<d_token._T_Range> => {
        switch ($[0]) {
            case 'Ja': return _p.ss($, ($) => _psh.wrap_state_group(['Ja', null]))
            case 'Nee': return _p.ss($, ($) => _psh.wrap_state_group(['Nee', ({
                'Balans item': _p.cc($['Balans item'], ($) => _psh.wrap_reference($)),

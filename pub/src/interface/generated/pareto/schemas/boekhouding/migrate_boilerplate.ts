...
export namespace _T_Fiscaal {
    ...
    export type RESULT = _i_out._T_Fiscaal<null>
}
...
export namespace _T_Grootboek_Categorieen {
    ...
    export type RESULT = _i_out._T_Grootboek_Categorieen<null>
}
...
export namespace _T_Beheer {
    ...
    export type RESULT = _i_out._T_Beheer<null>
}
...
export namespace _T_Grootboekrekeningen {
    ...
    export type RESULT = _i_out._T_Grootboekrekeningen<null>
}
...
export namespace _T_Jaarbeheer {
    ...
    export type RESULT = _i_out._T_Jaarbeheer<null>
}
...
export namespace _T_Overige_balans_item {
    ...
    export type RESULT = _i_out._T_Overige_balans_item<null>
}
...
export namespace _T_Verwijzing_naar_Informele_rekening {
    ...
    export type RESULT = _i_out._T_Verwijzing_naar_Informele_rekening<null>
}
...
export namespace _T_Verwijzing_naar_Bankrekening {
    ...
    export type RESULT = _i_out._T_Verwijzing_naar_Bankrekening<null>
}
...
export namespace _T_Handelstransacties {
    ...
    export type RESULT = _i_out._T_Handelstransacties<null>
}
...
export namespace _T_Mutaties {
    ...
    export type RESULT = _i_out._T_Mutaties<null>
}
...
export namespace _T_Jaren {
    ...
    export type RESULT = _i_out._T_Jaren<null>
}
...
export namespace _T_Balans_Resultaat_Mutatie {
    ...
    export type RESULT = _i_out._T_Balans_Resultaat_Mutatie<null>
}
...
export namespace _T_Eerste_boekjaar {
    ...
    export type RESULT = _i_out._T_Eerste_boekjaar<null>
}
...
export namespace _T_Root {
    ...
    export type RESULT = _i_out._T_Root<null>
}
